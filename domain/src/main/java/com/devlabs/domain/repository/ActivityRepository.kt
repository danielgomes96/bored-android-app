...
interface ActivityRepository {
    ...
    suspend fun finishActivity(activity: Activity, minutes: Int): Flow<ResultWrapper<Unit>>
    suspend fun abandonActivity(activity: Activity, minutes: Int): Flow<ResultWrapper<Unit>>
}